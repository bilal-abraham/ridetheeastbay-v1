...
const About = () => {
    return (
        <Fragment>
            ...
            <div className="frag">
                <div className="row">
                    <AboutCard img="/images/img-bilal.jpg" name="Bilal Abraham" position="Co-Founder / Website Developer" desc="I am a sophomore at Head-Royce School, and I love to code and mountain bike. I am the devloper of our site and am also our initiave helping buy, maintenance, and deliver bikes to kids in need." email="bilal.abraham.717@gmail.com" />
                    <AboutCard img="/images/img-joaquin.jpg" name="Joaquin Gonzalez" position="Co-Founder" desc="I am a sophomore at Head-Royce School, and I love biking. I have been going to the monthly bike party rides in the east bay since I was a little kid. I want to help those enjoy an activity that I love so much by making it accessible to those who can are in need of a bike. Oakland has had a bike boom recently during covid, and I hope to spread happiness and get more people riding!" email="joaquing2023@headroyce.org" />
