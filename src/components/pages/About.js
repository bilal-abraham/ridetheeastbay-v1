...
const About = () => {
    return (
        <Fragment>
            ...
            <div className="frag">
                <div className="row">
                    <AboutCard img="/images/img-bilal.jpg" name="Bilal Abraham" position="Co-Founder / Website Developer" desc="I am a sophomore at Head-Royce School, and I am an avid mountain biker and the devloper of our site. Biking before and through quarintine has helped me get through the dreaded quarintine and my goal is to help as many kids as possible do the same." email="bilal.abraham.717@gmail.com" />
